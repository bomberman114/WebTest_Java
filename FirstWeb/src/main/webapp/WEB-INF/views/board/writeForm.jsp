...
<script src="https://cdn.ckeditor.com/ckeditor5/35.2.0/classic/ckeditor/translations/ko.js"></script> -->
  ...
  <h2>게시글 작성</h2>
	...
	<form action="/Board/Write" method="Post">
		...
		<span>내용</span> <br>
		 ...
		 <textarea cols="100" rows="30" name="boardcontent" id="classic"></textarea> 
		<br>
		<br>
